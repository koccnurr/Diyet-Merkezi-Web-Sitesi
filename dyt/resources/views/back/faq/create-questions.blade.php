	...
	<div class="row">
		<div class="col-md-12 col-lg-12">
			<div class="card card-outline-secondary">
				<h4 class="card-title"><strong>Soru Ekle </strong></h4>
				<div class="row">
					<div class="col-md-2"></div>
					<div class="col-md-8">
						<div class="card-body">
							{!!BootForm::open([ 'method' => 'POST', 'route' => 'postCreateFAQ' ])->enctype("multipart/form-data")!!}
							...
							<div class="row" style="margin-bottom: 5px;">
								...
								<div class="col-md-10">
									<input type="text" name="soru_baslik" class="form-control">
								</div>
							</div>
							...
							<div class="row" style="margin-bottom: 5px;">
								...
								<div class="col-md-10">
									<textarea class="form-control" name="soru_aciklama"></textarea>                 
								</div>
							</div>
